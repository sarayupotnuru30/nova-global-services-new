...
const WA_CONSULTATION = waMsg("Hello Nova Global Immigration and Tours! I'd like to get a free consultation regarding your visa and travel services. Could you please guide me?");
const WA_EXPERT = waMsg("Hi Nova Global Immigration and Tours! I'd love to speak with a visa expert. Could you please help me with my queries?");
const WA_CALLBACK = waMsg("Hello Nova Global Immigration and Tours! I'd appreciate a free callback within 10 minutes to discuss my travel/visa requirements. Thank you!");
const WA_CTA_BOTTOM = waMsg("Hi Nova Global Immigration and Tours! I'm interested in starting my global journey. Could you please provide me a free consultation?");
  ...
  <div className="overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Nova Global Immigration and Tours is your one-stop destination for visa processing, travel planning, and career abroad support. With years of experience and thousands of satisfied clients, we provide end-to-end assistance to make your global dreams a reality.
            </p>
          ...
          {packages.map((p, i) => (
            <motion.div key={p.title} custom={i} initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="group bg-card rounded-2xl overflow-hidden shadow-card hover:shadow-nova transition-shadow">
              ...
              <div className="p-6">
                ...
                <a
                  href={waMsg(`Hello Nova Global Immigration and Tours! I'm interested in your "${p.title}" package. Could you please share more details and pricing? Thank you!`)}
                  target="_blank"
    ...
    <section className="py-20 bg-card">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { name: "Rajesh Kumar", text: "Nova Global Immigration and Tours made my USA visa process incredibly smooth. Highly recommended!", role: "Tourist Visa Client" },

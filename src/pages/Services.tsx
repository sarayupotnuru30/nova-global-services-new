...
const ServiceCard = ({ img, title, desc, i }: { img: string; title: string; desc: string; i: number }) => (
  ...
  >
    ...
    <div className="p-6">
      ...
      <a
        href={waMsg(`Hello Nova Global Immigration and Tours! I'm interested in your "${title}" service. Could you please provide more details? Thank you!`)}
        target="_blank"
    ...
    <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center">
      ...
      <div className="relative z-10 text-center">
        ...
        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.3 }} className="mt-4 text-primary-foreground/80 text-lg">
          Comprehensive visa, travel, and career Immigration and Tours
        </motion.p>
      </div>
    </section>

...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const text = `Hello Nova Global Immigration and Tours !%0A%0AMy name is ${encodeURIComponent(form.name)}.%0APhone: ${encodeURIComponent(form.phone)}%0AService Interested In: ${encodeURIComponent(form.service)}%0AMessage: ${encodeURIComponent(form.message)}%0A%0AKindly assist me. Thank you!`;
    ...
    <div>
      ...
      <section className="h-[400px]">
        <iframe
          ...
          title="Nova Global Immigration and Tours Location"
        />
      </section>
    </div>
  );

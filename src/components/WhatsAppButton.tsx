...
const WA_FLOAT = `https://wa.me/918143188042?text=${encodeURIComponent("Hi Nova Global Immigration and Tours! I have a quick query. Could you please assist me? Thank you!")}`;
